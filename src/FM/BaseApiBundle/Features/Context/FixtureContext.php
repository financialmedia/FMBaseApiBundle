...
{
    /**
     * @Given /^an api user named "([^"]*)" with password "([^"]*)" exists$/
     */
    ...
    /**
     * @Given /^a user named "([^"]*)" with password "([^"]*)" exists$/
     */
    ...
    /**
     * @Given /^the entity "([^"]*)" with id (\d+) does not exist$/
     */
    public function theEntityWithIdDoesNotExist($entityName, $id)
    {
        ...
        assertNull($entity, "Result of 'findOneById' should be NULL when an entity does not exist");
    }
}
